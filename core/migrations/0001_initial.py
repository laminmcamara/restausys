# Generated by Django 5.2.7 on 2026-04-04 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["order"], name="core_orderi_order_i_b7b8d3_idx"
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="order",
            index=models.Index(
                fields=["restaurant", "order_type"],
                name="core_order_restaur_2f8619_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="order",
